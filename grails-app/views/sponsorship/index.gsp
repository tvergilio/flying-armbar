		...
		<div id="list-sponsorship" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="sponsorship.course.label" default="Course" /></th>
				...
				<g:each in="${sponsorshipInstanceList}" status="i" var="sponsorshipInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${sponsorshipInstance.id}">${fieldValue(bean: sponsorshipInstance, field: "course")}</g:link></td>
