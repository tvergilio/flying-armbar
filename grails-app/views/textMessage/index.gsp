...
<html>
	...
	<body>
		<a href="#list-textMessage" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-textMessage" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="subject" title="${message(code: 'textMessage.subject.label', default: 'Subject')}" />
					
						<g:sortableColumn property="content" title="${message(code: 'textMessage.content.label', default: 'Content')}" />
				...
				<g:each in="${textMessageInstanceList}" status="i" var="textMessageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${textMessageInstance.id}">${fieldValue(bean: textMessageInstance, field: "subject")}</g:link></td>
