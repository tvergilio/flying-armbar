			...
			<ol class="property-list task">
				...
				<li class="fieldcontain">
					<span id="assignedTo-label" class="property-label"><g:message code="task.assignedTo.label" default="Assigned To" /></span>
						...
						<span class="property-value" aria-labelledby="assignedTo-label"><g:link controller="user" action="show" id="${taskInstance?.assignedTo?.id}">${taskInstance?.assignedTo?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${taskInstance?.course}">
				<li class="fieldcontain">
					<span id="course-label" class="property-label"><g:message code="task.course.label" default="Course" /></span>
					
						<span class="property-value" aria-labelledby="course-label"><g:link controller="course" action="show" id="${taskInstance?.course?.id}">${taskInstance?.course?.encodeAsHTML()}</g:link></span>
